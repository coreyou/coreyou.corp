...
/**
 * 要記得在本檔按右鍵 > Build Path > Configure Build Path > Libraries > Add External JARs > 找到Tomecat下的lib中的mysql JAR檔
 * 
 * @author coreyou
 *
 */
public class EasyTestMySQL {
	...
	private static String URL = "jdbc:mysql://localhost/coreyou_corp?useUnicode=true&characterEncoding=Big5";
	...
	public static void main(String[] args) {
		...
		EasyTestMySQL mysql = new EasyTestMySQL(); 
